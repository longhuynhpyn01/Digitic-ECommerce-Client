                            ...
                            <div className="my-3">
                                ...
                                <div className="d-flex gap-10 flex-column my-3">
                                    ...
                                    <p className="product-data">
                                        ...
                                        all orders. We ship all US domestic
                    ...
                    <div className="col-12">
                        ...
                        <div className="bg-white p-3">
                            <p>
                                ...
                                voluptate, exercitationem eum a totam fugiat qui
                                corporis repudiandae, dignissimos sunt facilis
                                magnam animi, blanditiis quas minus tempora?
                                Alias!
                            </p>
                        </div>
                    </div>
                            ...
                            <div className="reviews mt-4">
                                <div className="review">
                                    <div className="d-flex gap-10 align-items-center">
                                        <h6 className="mb-0">Long Huynhhh</h6>
                                        <ReactStars
                                            count={5}
                                            size={24}
                                            value={3}
                                    ...
                                    <p className="mt-3">
                                        Lorem ipsum dolor sit, amet consectetur
                                        adipisicing elit. Ex, sint, veritatis
                                        est corrupti repudiandae aperiam
                                        assumenda minima labore fugiat nesciunt
                                        obcaecati nihil mollitia. Libero laborum
                                        dolor reiciendis nisi! Autem, magnam.
                                    </p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="modal-body py-0">
                            <div className="d-flex align-items-center">
                                ...
                                <div className="d-flex flex-column flex-grow-1 w-50">
                                    ...
                                    <p className="mb-1">Quantity: 3</p>
                                    <p className="mb-1">Color: Yellow</p>
                                    <p className="mb-1">Size: M</p>
                                </div>
                            </div>
                        </div>
                        <div className="modal-footer py-0 border-0 justify-content-between gap-30">
                            <button
                                type="button"
                                className="button"
                                data-bs-dismiss="modal"
